...
const createVideoValid_1 = require("./validations/createVideoValid");
const updateVideoValid_1 = require("./validations/updateVideoValid");
...
app.post('/videos', createVideoValid_1.createVideoValid, VideoController.createOne);
app.put('/videos/:id', updateVideoValid_1.updateVideoValid, VideoController.updateOne);
